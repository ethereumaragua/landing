      ...
      >
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
           ...
           <div className="relative col-span-4 p-8 border-2 border-solid h-max rounded-2xl border-dark bg-light dark:border-light dark:bg-dark xl:col-span-4 md:col-span-8 md:order-3 ">
              <div className="absolute  top-0 -right-3 -z-10 h-[103%] w-[102%]  rounded-[2rem] rounded-br-3xl bg-dark dark:bg-light"/>
              <Image
                className="w-full h-auto rounded-2xl"
                src={ethimg}
            ...
            <div className="flex flex-col items-start justify-start col-span-4 xl:col-span-4 md:order-4 md:col-span-8">
              <h2 className="mb-4 text-lg font-bold uppercase text-dark/75 dark:text-light/75">
                ¿Qué es Ethereum?
              </h2>
              <p className="font-medium ">
                ...
                <br/><br/>
                Ethereum cuenta con una gran comunidad de desarrolladores y usuarios y es usada en la construcción de aplicaciones, servicios financieros, juegos y mucho más.
              </p>
            </div>
